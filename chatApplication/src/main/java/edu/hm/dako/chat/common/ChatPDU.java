...
public class ChatPDU implements Serializable {
	...
	public String toString() {
		...
		return "\n"
				...
				+ "numberOfReceivedChatMessages: " + this.numberOfReceivedChatMessages + ", " + "\n"
				+ "numberOfSentEvents: " + this.numberOfSentEvents + ", " + "\n" + "numberOfLostConfirms: "
	...
	/**
	 * Erstellt eine Confirm PDU, die dem Client der ein Message Confirm Event
	 * geschickt hat, geschickt wird. Teil aus der createChatMessageEventPdu...
	 * Methode kopiert
	 * 
	 * @author NECIBEDA
	 * @param eventInitiator
	...
	public static ChatPDU createConfirmEventPdu(String userName, ChatPDU receivedPdu) {
		...
		pdu.setServerThreadName(receivedPdu.getClientThreadName());
		pdu.setUserName(userName);
	...
	/**
	 * Erstellt eine Confirm PDU, die dem Client der ein Login Confirm Event
	 * geschickt hat, gesendet wird. Teil aus der createLoginEventPdu... Methode
	 * kopiert
	 * 
	 * @author NECIBEDA
	 * @param eventInitiator
	...
	/**
	 * Erstellt eine Confirm PDU, die dem Client der ein Confirm Event geschickt
	 * hat, gesendet wird. Teil aus der createLogoutEventPdu... Methode kopiert
	 * 
	 * @author NECIBEDA
	 * @param eventInitiator
	 * @param numberOfSentEvents
